...
Scenario: End to end scenario 
    Given The page title is "swagLabs"
    And I enter the value "standard_user" to the element "userNameInput" 
    And I should see that the "userNameOutput" is displayed
    And I enter the value "secret_sauce" to the element "passwordInput"
